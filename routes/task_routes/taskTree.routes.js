...
router.post("/task/:taskId/request-deadline-extension", verifyCoworkToken, verifyEmployeeToken, async (req, res) => {
    try {
        ...
        // task.dueDate/fixedDeadline directly, not etcHours — an office-hours
        // walk against the requested-hours estimate could hit 70%+ purely
        // from calendar time passing, even before any work had started. ──
