// models/Accountant_model/PinnedItem.js
//
...
//
// Why a separate collection instead of an array on AccountantUser?
...
const pinnedItemSchema = new mongoose.Schema(
  {
    ...
    entityType: {
      ...
      //   "ledger"     → TallyLedger (Mongo _id)
      //   "vendor"     → Vendor (Mongo _id)
      //   "customer"   → Customer (Mongo _id)
      //   "invoice"    → Invoice (Mongo _id)
  ...
  { timestamps: true, collection: "accountant_pinned_items" },
);
...
const PinnedItem =
  mongoose.models.PinnedItem || mongoose.model("PinnedItem", pinnedItemSchema);
