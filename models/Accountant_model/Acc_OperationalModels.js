    ...
    payments: [
      {
        ...
        notes: { type: String },
        recordedBy: { type: mongoose.Schema.Types.ObjectId, ref: "Acc_Department" },
      },
    ],
...
const bankTransactionSchema = new mongoose.Schema(
  {
    ...
    reconciledBy: { type: mongoose.Schema.Types.ObjectId, ref: "Acc_Department" },
...
const chartOfAccountsSchema = new mongoose.Schema(
  {
    ...
    parentAccount: { type: mongoose.Schema.Types.ObjectId, ref: "Acc_ChartOfAccounts" },
...
const activityLogSchema = new mongoose.Schema(
  {
    accountantId: { type: mongoose.Schema.Types.ObjectId, ref: "Acc_Department", required: true },
...
const Acc_BankTransaction = mongoose.model("Acc_BankTransaction", bankTransactionSchema);
...
const Acc_ChartOfAccounts = mongoose.model("Acc_ChartOfAccounts", chartOfAccountsSchema);
const Acc_CreditDebitNote = mongoose.model("Acc_CreditDebitNote", creditDebitNoteSchema);
